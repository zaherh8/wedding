defmodule Wedding.Application do
  ...
  @invitees [
    ...
    %{coming: true, first_name: "Roger", group: "maryroger", last_name: "Saliba"},
    %{coming: true, first_name: "Mary", group: "maryroger", last_name: "Saliba"},
    ...
    %{coming: false, first_name: "Mira", group: "", last_name: "Saliba"},
    ...
    %{coming: true, first_name: "Gaelle", group: "", last_name: "Maatouk"},
    %{coming: false, first_name: "Raed ", group: "Bacouni", last_name: "Bacouni"},
    %{coming: false, first_name: "Dania", group: "Bacouni", last_name: "Bacouni"},
